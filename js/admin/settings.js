        ...
        <div class="card">
            ...
            <div class="card-body">
                <div style="max-width: 500px; margin: 0 auto;">
                    <h4 style="margin-bottom: 20px;">修改管理员密码</h4>
                    ...
                    <h4 style="margin-bottom: 20px;">管理员注册密码设置</h4>
                    <div class="form-group">
                        <label>当前管理员注册密码</label>
                        <input type="text" id="currentAdminPassword" class="form-control" value="${ADMIN_REGISTER_PASSWORD}" readonly>
                        <small class="form-text text-muted">这是在 firebase-config.js 中设置的密码，用于新管理员注册</small>
                    </div>
